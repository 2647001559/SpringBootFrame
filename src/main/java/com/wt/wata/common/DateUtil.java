...
import com.wt.wata.common.enums.DateEnum;
...
public class DateUtil implements Serializable {
     ...
     * 时间格式转换类初始化，采用静态加载
     */
    public static SimpleDateFormat time01;      //年-月-日   时：分：秒
    public static SimpleDateFormat time02;      //年-月-日
    public static SimpleDateFormat time03;      //年月日
    public static SimpleDateFormat time04;      //时：分：秒
    public static SimpleDateFormat time05;      //时分秒
    public static SimpleDateFormat time06;      //年月日时分秒
    public static SimpleDateFormat time07;      //年
    public static SimpleDateFormat time08;      //年-月
        static {
    ...
    public static String timeDifference(Date param01, Date param02, DateEnum dateEnum){
        try{
            ...
            long time = (long)(param02.getTime()-param01.getTime());
            switch (dateEnum){
                case Y:
